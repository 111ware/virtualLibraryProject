...
int cargaBaseDatos()
{
    ...
    while(tolower(eleccionCarga) == 's')
    {
        ...
        if(error == 0)
        {
            printf("Presione s para continuar cargando libros, n para volver al menu: \n");
            fflush(stdin);
...
int libgenero(char *genero)
{
    ...
    if(flag==1)
    {
        ...
        case 4:
            ...
            strcpy(genero, "Cientifico");
            break;
        case 5:
            strcpy(genero, "Historico");
            break;
        case 6:
            strcpy(genero, "Infantil");
            break;
        case 7:
            strcpy(genero, "Novela");
            break;
        case 8:
            strcpy(genero, "Policial");
            break;
        case 9:
